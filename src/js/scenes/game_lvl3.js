...
export class Level3 extends Scene {
  ...
  constructor() {
    ...
    this.goLevel4 = new MovableObject(
      1,
    ...
    this.thirdSign = new Secret_sign(
      this,
      2100,
      -200,
      this.firstPigeon.pigeonLabel7
    );
    this.thirdSign2 = new Secret_sign(
      this,
      -500,
      1200,
      this.firstPigeon.pigeonLabel8
    );
  }
  ...
  scored(evt) {
    if (evt.other instanceof MovableObject) {
      ...
      if (this.yourScore === this.winScore) {
        ...
        this.encounterFile.src = bgMusic;
      }
    }
  }
  enemyScored(evt) {
