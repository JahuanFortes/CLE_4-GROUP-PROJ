...
export class Level1 extends Scene {
  ...
  constructor() {
    ...
    this.breakingWallImg = new MovableObject(
      1,
      Resources.Onewall.toSprite(),
      CollisionType.Fixed,
      1005,
      -175
    );
    this.breakingWallFence = new MovableObject(
      1,
      Resources.Fence.toSprite(),
      CollisionType.Fixed,
      1850,
      200
    );

    this.breakingWallRock = new MovableObject(
      1,
      Resources.Moverock.toSprite(),
      CollisionType.Fixed,
      -250,
      950
    );
    ...
    this.nextLevel = new MovableObject(
      1,
    ...
    this.firstSign = new Secret_sign(
      this,
      -900,
      -400,
      this.firstPigeon.pigeonLabel1
    );
    this.firstSign2 = new Secret_sign(
      this,
      2000,
      -500,
      this.firstPigeon.pigeonLabel2
    );
    this.firstSign3 = new Secret_sign(
      this,
      2300,
      1300,
      this.firstPigeon.pigeonLabel3
    );
  }
  ...
  onInitialize(engine) {
    ...
    console.log("adding the bg music via oninitialise");
  }

  onActivate(ctx) {
    //adds players to scene and gives them the right id and location
    console.log("Level1 has started via onactivate");
